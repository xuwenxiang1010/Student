...
CREATE TABLE `game_player` (
  ...
  `vitality` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  ...
  `strenght` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`)
...
-- ----------------------------
-- Table structure for sys_family
-- ----------------------------
DROP TABLE IF EXISTS `sys_family`;
CREATE TABLE `sys_family` (
  `familyId` bigint(20) NOT NULL AUTO_INCREMENT,
  `faFatherId` bigint(20) DEFAULT NULL,
  `faName` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`familyId`)
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

-- ----------------------------
-- Records of sys_family
-- ----------------------------
...
-- ----------------------------
-- Table structure for sys_god_partner
-- ----------------------------
DROP TABLE IF EXISTS `sys_god_partner`;
CREATE TABLE `sys_god_partner` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `sys_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=583 DEFAULT CHARSET=utf8 COMMENT='系统日志';
...
CREATE TABLE `sys_partner` (
  ...
  `paName` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `paGender` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `paAge` int(10) DEFAULT NULL,
  `sign` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `qualityId` bigint(20) DEFAULT NULL,
...
-- ----------------------------
-- Table structure for sys_quality
-- ----------------------------
DROP TABLE IF EXISTS `sys_quality`;
CREATE TABLE `sys_quality` (
  `qualityId` bigint(20) NOT NULL AUTO_INCREMENT,
  `quFatherId` bigint(20) DEFAULT NULL,
  `quName` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`qualityId`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

-- ----------------------------
-- Records of sys_quality
-- ----------------------------
...
CREATE TABLE `sys_role_menu` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3190 DEFAULT CHARSET=utf8 COMMENT='角色与菜单对应关系';
...
-- ----------------------------
-- Table structure for sys_user_role_copy
-- ----------------------------
DROP TABLE IF EXISTS `sys_user_role_copy`;
CREATE TABLE `sys_user_role_copy` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `user_id` bigint(20) DEFAULT NULL COMMENT '用户ID',
  `role_id` bigint(20) DEFAULT NULL COMMENT '角色ID',
  PRIMARY KEY (`id`)
